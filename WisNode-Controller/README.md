...
1) pour que ça marche, il faut faire un electron-rebuild 
donc : npm install --save-dev electron-rebuild. ensuite bind le goal "install" de npm à la commande "electron-rebuild"
à partir de là le serialport ne foutra plus le bronx après un npm install
