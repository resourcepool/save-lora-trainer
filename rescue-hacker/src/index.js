...
const RAK811_DEVICE_PROFILE_ID = utils.hexStringToBytes('1d99a006-e617-4fb3-9ffe-a71567ee36a7');
  ...
  if (decoder.isJoinRequest()) {
    ...
    if (utils.arraysEqual(result.appEui, VALID_APP_EUI)) {
      api.createDevice({
          ...
          serviceProfileId: LORA_SERVICE_PROFILE_ID,
          routingProfileId: LORA_ROUTING_PROFILE_ID
      });
    }
  }
});